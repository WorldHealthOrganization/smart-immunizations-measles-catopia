...
* caregiver 0..* BackboneElement "Caregiver" "The client's caregiver (person) which could be next of kin (e.g. partner, husband, mother, sibling, etc.)"
  * ^code[+] = IMMZ.C#DE14
  * firstName 0..1 string "Mother/Guardian's first name" "First or given name of the client's caregiver"
    * obeys IMMZ-C-name-1
    * ^code[+] = IMMZ.C#DE16
 * familyName 0..1 string "Mother/Guardian's Middle name" "Family name or last name of the client's caregiver"
    * obeys IMMZ-C-name-1
    * ^code[+] = IMMZ.C#ttttttttt
  * familyName 0..1 string "Mother/Guardian's Last name" "Family name or last name of the client's caregiver"
    * obeys IMMZ-C-name-1
    * ^code[+] = IMMZ.C#DE17
* firstName 0..1 string "Father/Guardian's first name" "First or given name of the client's caregiver"
    * obeys IMMZ-C-name-1
    * ^code[+] = IMMZ.C#sssssss
 * familyName 0..1 string "Father/Guardian's Middle name" "Family name or last name of the client's caregiver"
    * obeys IMMZ-C-name-1
    * ^code[+] = IMMZ.C#ttttttttt
  * familyName 0..1 string "Father/Guardian's Last name" "Family name or last name of the client's caregiver"
    * obeys IMMZ-C-name-1
    * ^code[+] = IMMZ.C#DE17
...
* administrativeArea 0..1 CodeableConcept "Administrative area" "The name of the County/subcounty/ward/chu of where the client lives"
  * ^code[+] = IMMZ.C#DE19
* administrativeArea 0..1 CodeableConcept "County" "The name of the County of where the client lives"
  * ^code[+] = IMMZ.C#DE19.1
* administrativeArea 0..1 CodeableConcept "Subcounty" "The name of the Sub-County of where the client lives"
  * ^code[+] = IMMZ.C#DE19.2
* administrativeArea 0..1 CodeableConcept "Ward" "The name of the Ward of where the client lives"
  * ^code[+] = IMMZ.C#DE19.3
* administrativeArea 0..1 CodeableConcept "CHU" "The name of the CHU of where the client lives"
  * ^code[+] = IMMZ.C#DE19.4
